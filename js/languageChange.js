...
// de_btn_mob = document.getElementById('de_btn_mob');
// cn_btn_mob = document.getElementById('cn_btn_mob');
//
// lv_btn = document.getElementById('lv_btn');
// en_btn = document.getElementById('en_btn');
// de_btn = document.getElementById('de_btn');
// cn_btn = document.getElementById('cn_btn');
...
function set_session(lang){
    ...
    console.log('Setting settion to: ',lang)
...
function setActiveButton(el) {
    ...
    } else if (buttonId === 'de_btn') {
        otherButtonId = 'de_btn_mob';
    } else if (buttonId === 'de_btn_mob') {
        otherButtonId = 'de_btn';
    } else if (buttonId === 'cn_btn') {
        otherButtonId = 'cn_btn_mob';
    } else if (buttonId === 'cn_btn_mob') {
        otherButtonId = 'cn_btn';
    }
...
//     setActiveButton(this);
// });
// document.getElementById('de_btn').addEventListener('click', function () {
//     setActiveButton(this);
// });
