...
//} else {
    ...
    $GLOBALS['shop_email'] = 'kppro@shopdev.lv';
    $GLOBALS['shop_email_pw'] = 'O4&ewhm029yudqvHG';

    $GLOBALS['shop_receiving_email'] = 'kppro@shopdev.lv';
    $GLOBALS['shop_receiving_email_pw'] = 'O4&ewhm029yudqvHG';
